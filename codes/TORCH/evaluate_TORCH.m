function evaluation_info=evaluate_TORCH(XTrain,YTrain,XTest,YTest,LTest,LTrain,param)    
   ...
   S2 = LTrain(:, (param.num_class1+1):end)' *  LTrain(:, (param.num_class1+1):end); S2(S2>0) = 1;
    ...
    evaluation_info.Image_VS_Text_MAP_penalty = mAP_penalty(orderH', LTrain, LTest, param);
    ...
    evaluation_info.Text_VS_Image_MAP_penalty = mAP_penalty(orderH', LTrain, LTest, param);
